...
namespace WitsWay.Utilities.Extends
{
    ...
    public static class ObjectExtends
    {
        ...
        {
            return ReferenceEquals(target, null) ? null : target.ToString();
        }
        ...
        public static string PackJson<T>(this T entity) where T : class, new()
        {
        ...
        /// <typeparam name="T">对象类型</typeparam>
        /// <returns>序列化后字符串</returns>
        public static string PackXml<T>(this T entity) where T : class, new()
        {
        ...
        /// <returns>序列化后字符串</returns>
        public static string Pack<T>(this T entity, string parserName) where T : class, new()
        {
            ...
            if (parser == null)
                ExceptionHelper.ThrowProgramException(UtilityErrors.NotSupportParseProvider, parserName);
