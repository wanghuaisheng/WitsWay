...
namespace WitsWay.Utilities.Apis.Attributes
{
    ...
    /// 需要所有指定权限特性
    /// </summary>
    public class RequireAllAuthorizeAttribute : ActionFilterAttribute
    {
        ...
        public RequireAllAuthorizeAttribute(params int[] requiredPermission)
        {
        ...
        public override void OnActionExecuting(HttpActionContext actionContext)
        {
            ...
            else
            {
                ...
                if (!controller.HasAllPermission(_requiredPermission))
                {
