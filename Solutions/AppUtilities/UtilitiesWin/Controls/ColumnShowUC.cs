    ...
    public partial class ColumnShowUC : XtraUserControl
    {
        ...
        private void CommandHide()
        {
            ...
            if (item != null)
            {
                ...
                if (shows.Count == 1)
                {
                    UtilityHelper.ShowInfoMessage("至少要有一个显示列");
                    return;
                }
                item.ImageIndex = 1;
                shows.Remove(item);
        ...
        private void CommandUp()
        {
            ...
            if (item != null)
            {
                ...
                {
                    UtilityHelper.ShowInfoMessage("选中显示列已经是第一列了");
                }
                else
                {
                    //上移操作
            ...
            {
                UtilityHelper.ShowInfoMessage("请选择要上移的显示列");
            }
        }
        ...
        private void CommandDown()
        {
            ...
            if (item != null)
            {
                ...
                {
                    UtilityHelper.ShowInfoMessage("选中显示列已经是最后一列了");
                }
                else
                {
                    //下移操作
            ...
            {
                UtilityHelper.ShowInfoMessage("请选择要下移的显示列");
            }
        }
