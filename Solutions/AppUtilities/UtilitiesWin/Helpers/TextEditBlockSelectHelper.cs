...
namespace WitsWay.Utilities.Win.Helpers
{
    ...
    public class TextEditBlockSelectHelper<TEntity>
    {
        ...
        private List<TEntity> _entityList = new List<TEntity>(); // 块实体列表
        private Dictionary<TEntity, string> _displayDictionary; // 显示字符串字典
        private IEqualityComparer<TEntity> _equalityComparer;
