...
{
    public partial class TabMainForm3 : DevExpress.XtraBars.TabForm
    {
        public TabMainForm3()
        {
            InitializeComponent();
        ...
        private void TabMainForm3_Load(object sender, EventArgs e)
        {
            propertyGridControl1.SelectedObject = _navBarControl;
        }
    }
}
